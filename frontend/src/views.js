...
export const VIEWS = [
  ...
  { id: 'directory', group: 'Governance', icon: 'user', label: 'Employee directory',
    description: 'Add people, keep reporting lines right, and archive anyone who leaves without losing their history.',
    allowed: (session) => can(session, 'employee.edit') },
